...
namespace po.Migrations
{
    ...
    [Migration("20260205192809_RandomMessageNotificationChannel")]
    partial class RandomMessageNotificationChannel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.HasSequence("RandomMessageIds")
                .StartsAt(600L);

            modelBuilder.HasSequence("ScheduledBlobIds")
                .StartsAt(1200L);

            modelBuilder.HasSequence("ScheduledMessageIds")
                .StartsAt(10L);
            ...
            modelBuilder.Entity("po.Models.RandomMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("po.Models.ScheduledBlob", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("ScheduledBlobs");
                });

            modelBuilder.Entity("po.Models.ScheduledMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
