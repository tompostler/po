namespace po.DataAccess
{
    public interface IPoStorage
    {
        ...
        Task<Stream> DownloadBlobIfExistsAsync(string containerName, string blobName, CancellationToken cancellationToken);

        Task<bool> DeleteBlobIfExistsAsync(string containerName, string blobName, CancellationToken cancellationToken);
    }
}
